        ...
        <div className='mt-12'>
          {showGraph ? <svg onClick={()=>{setShowGraph(!showGraph)}} width="25" height="18" viewBox="0 0 25 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg onClick={()=>{setShowGraph(!showGraph)}} width="25" height="18" viewBox="0 0 25 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12.5 5.25C12.7109 5.25 12.8984 5.32031 13.0391 5.46094L17.5391 9.96094C17.8438 10.2422 17.8438 10.7344 17.5391 11.0156C17.2578 11.3203 16.7656 11.3203 16.4844 11.0156L12.5 7.05469L8.53906 11.0156C8.25781 11.3203 7.76562 11.3203 7.48438 11.0156C7.17969 10.7344 7.17969 10.2422 7.48438 9.96094L11.9844 5.46094C12.125 5.32031 12.3125 5.25 12.5 5.25Z" fill="black" fill-opacity="0.5" />
            </svg>
          }
        </div>
      </div>
